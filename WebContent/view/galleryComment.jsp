...
<meta charset="UTF-8">
<title>갤러리댓글</title>
<!-- 10/24_이서현_수정사항_갤러리 댓글 틀 변형. 
수정 전 : 맨위에 제목->중간에 날짜-> 맨밑 내용  / 
수정 후 : 맨위에 제목 
       ->중간에 내용 
       ->맨밑 날짜  
...
<body style="background-color:white;">	<!-- 댓글 리스트 -->
	<ul id="main">
		<c:forEach var="cmt" items="${clist}">
			<li>
				<ul>
					...
					<li><a href="galleryCommentDelete.do?u_idx=${cmt.u_idx }&idx=${cmt.idx }&gallery_idx=${cmt.gallery_idx }" style="background-color: #F59B7A;">삭제</a></li>
					<br></c:if>
				</ul>
			</li>
