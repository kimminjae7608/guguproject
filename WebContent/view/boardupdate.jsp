...
<c:if test="${sessionScope.user != null}">
    ...
    <div class="box">
           	...
           	<form action="updatesave.do?u_idx=${user.idx }&v_idx=${v_idx}&idx=${board.idx}" method="post" >
           <div class="box2">
            <!-- <p class="typo">GuGu board</p> -->
            <table>
                
                <tr><th>제목</th>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="subject" value="${board.subject}" size="50" required></td>
                </tr>
                <tr>
                  <!--  <th>작성자</th>
                ...
                <tr><th>내용</th>  <!-- textarea 의 크기 : rows="20" cols="80" -->
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;
                    <textarea  rows="8" cols="80" name="content" required>${board.content}</textarea>
               ...
               <hr>
                ...
                <input type="reset" value="게시판" class="btn3" onclick="location.href='guguboard.do?u_idx=${user.idx}&v_idx=${v_idx }'" >
                </tABLE>
            </div>
            </form>
            </div>
